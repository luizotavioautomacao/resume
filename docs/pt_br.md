...
#### Dono | [Gotech.Education](https://gotech.education) - Campinas, SP | Set/2023 – Atualmente  
...
- **Rede & Protocolos**: DNS, SSL, HTTPS, TCP/IP, REST, JSON, Cliente-Servidor  
- **Ferramentas**: Git, Swagger, Hubspot, JIRA, Office, Web scraping, Charles Proxy  
- **Boas práticas**: Clean Architecture, SOLID, TDD, Scrum, Kanban, PMBOK  
